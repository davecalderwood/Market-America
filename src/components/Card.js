...
const ItemCard = (props) => {
  ...
  return (
    ...
    <CardDeck className="deck flip-box aspectwrapper">
      ...
      <CardTitle className="title"> Handcrafted Frozen Bacon </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: N/A</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Licensed Fresh Keyboard </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Fantastic Granite Fish </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: N/A</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Small Soft Gloves </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: N/A</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Rustic Cotton Pants </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: N/A</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Handmade Wooden Shirt </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: Blick - Spinka</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Fantastic Metal Shirt </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: N/A</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Tasty Fresh Chicken </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: N/A</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Generic Metal Computer </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: N/A</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Practical Fresh Hat </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: Shields - Christiansen</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Small Concrete Chicken </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: O'Hara - Bradtke</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Rustic Rubber Table </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: Franecki, Vandervort and Mertz</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Sleek Fresh Bike </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: Corkery, Hickle and Schamberger</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Unbranded Rubber Shirt </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: McClure Inc</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Sleek Cotton Shirt </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: N/A</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Practical Cotton Chips </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: O'Connell, Ryan and Friesen</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Intelligent Metal Shoes </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: N/A</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Generic Plastic Computer </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: N/A</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Ergonomic Soft Keyboard </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: N/A</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Handcrafted Granite Cheese </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: N/A</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Intelligent Frozen Cheese </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: Ledner, Gulgowski and Swift</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Rustic Steel Gloves </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: N/A</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Unbranded Fresh Computer </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: N/A</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Licensed Wooden Bike </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: N/A</CardSubtitle>
      ...
      <Card className="cards flip-box-inner">
      <Container className="flip-box-front">
      <CardTitle className="title"> Unbranded Frozen Bacon </CardTitle><br/>
        <CardImg top width="100%" src="https://placebeard.it/400x400" alt="Card image cap" />
        <CardBody>
          <CardSubtitle>Brand: Eichmann, Schroeder and Cummerata</CardSubtitle>
